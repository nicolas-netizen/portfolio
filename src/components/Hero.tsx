          ...
          >
            <motion.img
              ...
              onError={(e) => {
                ...
                console.log('Trying fallback to initials...');
                e.currentTarget.style.display = 'none';
                const fallback = document.createElement('div');
                fallback.className = 'rounded-full w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 lg:w-64 lg:h-64 mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300 bg-gradient-to-br from-emerald-500 to-blue-600 flex items-center justify-center';
                fallback.innerHTML = '<span class="text-white text-4xl sm:text-5xl md:text-6xl font-bold">NP</span>';
